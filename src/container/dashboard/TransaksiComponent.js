                ...
                <ImageBackground source={bgImage} style={styles.backgroundContainer}>
                        ...
                        <View >
                            <View style={styles.inputContainer}>
                                <IconMaterial name={'account-balance-wallet'} size={28} color={'rgba(255, 255, 255, 0.7)'}
                                              style={styles.inputIcon}/>
                                <TextInput
                                    style={styles.input}
                                    placeholder={'Account Number Destination'}
                            ...
                            <View style={styles.inputContainer}>
                                <IconFa name={'money'} size={28} color={'rgba(255, 255, 255, 0.7)'}
                                        style={styles.inputIcon}/>
                                <TextInput
                                    style={styles.input}
                                    placeholder={'Amount'}
